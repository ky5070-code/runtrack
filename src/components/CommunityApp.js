  ...
  return (
    <div style={{ background: isMyPost ? "#0a0f0a" : "#0b0b0b", border: isMyPost ? "1.5px solid #00cc55" : "1px solid #181818", borderRadius: 18, overflow: "hidden", marginBottom: 12, boxShadow: isMyPost ? "0 2px 20px rgba(0,255,136,0.08)" : "none", isolation: "isolate" }}>
      ...
      <div style={{ padding: "14px 14px 12px" }}>
        ...
        {/* 이미지 - 이름 아래 */}
        {post.imageUrl && (
          <div style={{ borderRadius: 12, marginBottom: 12, width: "100%", height: 200, overflow: "hidden", flexShrink: 0, position: "relative" }}>
            <img src={post.imageUrl} alt="" style={{ position: "absolute", top: "50%", left: 0, width: "100%", transform: "translateY(-50%)", display: "block" }} />
          </div>
        )}
...
export default function CommunityApp({ currentUser, currentSet, onLeaveSet, onLogout, onUpdateProfile, onRedeemCoupon }) {
  ...
  return (
    <div style={{ height: "100%", background: "#060606", color: "#e0e0e0", fontFamily: "'Pretendard', -apple-system, sans-serif", maxWidth: 480, width: "100%", margin: "0 auto", display: "flex", flexDirection: "column", overflow: "hidden" }}>
