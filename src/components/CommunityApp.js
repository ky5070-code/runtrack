...
export default function CommunityApp({ currentUser, currentSet, onLeaveSet, onLogout, onUpdateProfile, onRedeemCoupon }) {
  ...
  return (
    <div style={{ height: "100dvh", background: "#060606", color: "#e0e0e0", fontFamily: "'Pretendard', -apple-system, sans-serif", maxWidth: 480, margin: "0 auto", display: "flex", flexDirection: "column", overflow: "hidden", position: "fixed", inset: "0 auto", width: "100%" }}>
      ...
      {/* 헤더 */}
      <div style={{ padding: `calc(14px + ${safeTop}) 18px 10px`, display: "flex", justifyContent: "space-between", alignItems: "center", position: "sticky", top: 0, background: "#060606", zIndex: 50, flexShrink: 0 }}>
        <div>
      ...
      {/* 주간 요약 - 채팅 탭에서는 숨김 */}
      <div style={{ margin: "0 18px 12px", background: "#0a0a0a", border: "1px solid #161616", borderRadius: 16, padding: "12px 16px", display: tab === "chat" ? "none" : "flex", position: "sticky", top: 58, zIndex: 49, flexShrink: 0 }}>
