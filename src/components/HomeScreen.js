    ...
    <div onClick={onClose} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.92)", zIndex: 200, display: "flex", alignItems: "flex-end" }}>
      <div onClick={e => e.stopPropagation()} style={{ width: "100%", maxWidth: 480, margin: "0 auto", background: "#0d0d0d", borderRadius: "22px 22px 0 0", border: "1px solid #1a1a1a", padding: "20px 20px", paddingBottom: `calc(24px + ${safeBottom})`, maxHeight: "90vh", overflowY: "auto" }}>
        ...
        <input value={name} onChange={e => setName(e.target.value)} placeholder="예: 대치동 러닝크루" maxLength={30}
          style={{ width: "100%", background: "#080808", border: "1px solid #1e1e1e", borderRadius: 12, padding: "13px 14px", color: "#e0e0e0", fontFamily: "inherit", fontSize: 16, outline: "none", marginBottom: 14, boxSizing: "border-box" }} />
        ...
        <textarea value={desc} onChange={e => setDesc(e.target.value)} placeholder="이 크루에 대해 소개해주세요" maxLength={100} rows={3}
          style={{ width: "100%", background: "#080808", border: "1px solid #1e1e1e", borderRadius: 12, padding: "13px 14px", color: "#e0e0e0", fontFamily: "inherit", fontSize: 15, outline: "none", resize: "none", marginBottom: 16, boxSizing: "border-box", lineHeight: 1.6 }} />
    ...
    <div onClick={onClose} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.92)", zIndex: 200, display: "flex", alignItems: "flex-end" }}>
      <div onClick={e => e.stopPropagation()} style={{ width: "100%", maxWidth: 480, margin: "0 auto", background: "#0d0d0d", borderRadius: "22px 22px 0 0", border: "1px solid #1a1a1a", padding: "20px 20px", paddingBottom: `calc(24px + ${safeBottom})`, maxHeight: "85vh", overflowY: "auto" }}>
        ...
        <input value={search} onChange={e => setSearch(e.target.value)} placeholder="러닝크루 이름 검색..."
          style={{ width: "100%", background: "#080808", border: "1px solid #1e1e1e", borderRadius: 12, padding: "12px 14px", color: "#e0e0e0", fontFamily: "inherit", fontSize: 16, outline: "none", marginBottom: 14, boxSizing: "border-box" }} />
        ...
        {filtered.map(s => (
          <div key={s.id} style={{ display: "flex", alignItems: "center", gap: 12, padding: "14px", background: "#080808", border: "1px solid #111", borderRadius: 14, marginBottom: 8 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              {s.description && <div style={{ fontSize: 13, color: "#444", marginTop: 2, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{s.description}</div>}
    ...
    <div style={{ height: "100%", overflowY: "auto", WebkitOverflowScrolling: "touch", background: "#060606", color: "#e0e0e0", fontFamily: "'Pretendard', -apple-system, sans-serif", maxWidth: 480, width: "100%", margin: "0 auto" }}>
      ...
      <div style={{ padding: "20px 20px", paddingBottom: `calc(24px + ${safeBottom})` }}>
        ...
        <div style={{ display: "flex", gap: 10, marginBottom: 24 }}>
          ...
          <button onClick={() => setShowJoin(true)} style={{ flex: 1, padding: "14px", background: "#0d0d0d", border: "1px solid #1e1e1e", borderRadius: 14, color: "#666", fontFamily: "inherit", fontSize: 16, fontWeight: 700, minHeight: 52 }}>
            🌍 러닝크루 찾기
          </button>
        </div>
